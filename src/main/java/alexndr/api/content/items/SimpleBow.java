...
public class SimpleBow extends ItemBow
{
	...
	public SimpleBow modId(String modId)
	{
		...
		list.add(this);
		this.modId = modId;
		if(SimpleBow.bowWithModIdMap.containsKey(modId))
			SimpleBow.bowWithModIdMap.get(modId).add(this);
		else
			SimpleBow.bowWithModIdMap.put(modId, list);
		return this;
	}
	...
	public void onPlayerStoppedUsing(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer, int par4)
	{
		...
		if((infArrows) || (par3EntityPlayer.inventory.hasItem(Items.arrow)))
		{
			...
			if(effects.containsKey(SimpleBowEffects.knockbackEffect))
				arrow.setKnockbackStrength(punchLevel > 0 
						? punchLevel + (Integer) effects.get(SimpleBowEffects.knockbackEffect) 
	...
	public void registerIcons(IIconRegister iconRegister)
	{
		...
		iconRegister.registerIcon(modId + ":" + this.bowTypeName + "_0");
